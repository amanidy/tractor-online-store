...
interface DetailTitleFormProps{
    initialData: {
        title: string;
    };
...
export const DetailTitleForm = ({
    initialData,
    tractorId,
    detailId,
}: DetailTitleFormProps) => {
    ...
    const onsubmit = async ( values: z.infer<typeof formSchema> ) => {
        try {
            ...
            toast.success("Detail title updated successfully")
            toggleEdit();
            router.refresh();
        } catch {
                                ...
                                <FormItem>
                                    <FormControl>
                                        <Input
                                            ...
                                            placeholder="e.g. 'Engine and performance'"
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormMessage
